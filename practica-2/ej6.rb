...
# Si no se recibe la cantidad de casilleros, aprovecho el valor por defecto para ese parámetro para evitar tener que llamar a #tirar_dado dentro del cuerpo del método.
